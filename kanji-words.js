...
window.KANJI_WORDS = [
  ...
  // 明 休 体 好 男 (semana 6)
  { w:'明るい', read:'あかるい', mean:'claro / alegre' },
  { w:'{説|せつ}明', read:'せつめい', mean:'explicação' },
  { w:'明日', read:'あした', mean:'amanhã' },
  { w:'休み', read:'やすみ', mean:'descanso / folga' },
  { w:'{昼|ひる}休み', read:'ひるやすみ', mean:'intervalo do almoço' },
  { w:'体', read:'からだ', mean:'corpo' },
  { w:'体力', read:'たいりょく', mean:'força física' },
  { w:'体{育|いく}', read:'たいいく', mean:'educação física' },
  { w:'好き', read:'すき', mean:'gostar (de)' },
  { w:'好{物|ぶつ}', read:'こうぶつ', mean:'comida/coisa favorita' },
  { w:'男', read:'おとこ', mean:'homem' },
  { w:'男の子', read:'おとこのこ', mean:'menino' },
  { w:'{長|ちょう}男', read:'ちょうなん', mean:'filho mais velho' },
  { w:'男子学生', read:'だんしがくせい', mean:'estudante (do sexo masculino)' },
  // 林 森 間 畑 岩 (semana 7)
  { w:'林', read:'はやし', mean:'bosque / mata' },
  { w:'森', read:'もり', mean:'floresta' },
  { w:'森林', read:'しんりん', mean:'floresta (mata)' },
  { w:'間', read:'あいだ', mean:'entre / intervalo' },
  { w:'人間', read:'にんげん', mean:'ser humano' },
  { w:'{時|じ}間', read:'じかん', mean:'tempo / hora' },
  { w:'一{週|しゅう}間', read:'いっしゅうかん', mean:'uma semana' },
  { w:'間に{合|あ}う', read:'まにあう', mean:'chegar a tempo' },
  { w:'畑', read:'はたけ', mean:'horta / campo cultivado' },
  { w:'{花|はな}畑', read:'はなばたけ', mean:'campo de flores' },
  { w:'岩', read:'いわ', mean:'rocha / rochedo' },
  { w:'岩山', read:'いわやま', mean:'montanha rochosa' },
  { w:'十二{時|じ}半', read:'じゅうにじはん', mean:'12h30 (meio-dia e meia)' }
];
